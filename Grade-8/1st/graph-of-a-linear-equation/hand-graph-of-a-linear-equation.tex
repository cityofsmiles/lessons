% cd /storage/emulated/0/Documents/documents/latex/1920/Grade-8/1st/graph-of-a-linear-equation && pdflatex hand-graph-of-a-linear-equation.tex && termux-open hand-graph-of-a-linear-equation.pdf
...
%\input{hand-graph-of-a-linear-equation-input1}
...
\input{ps-graph-of-a-linear-equation-input1}
\input{ps-graph-of-a-linear-equation-input2}
%\input{hand-graph-of-a-linear-equation-input2}
\input{ps-graph-of-a-linear-equation-input3}
\end{frame}
