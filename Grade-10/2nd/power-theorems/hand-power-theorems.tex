% cd /storage/emulated/0/Documents/documents/latex/1920/Grade-10/2nd/power-theorems && pdflatex hand-power-theorems.tex && termux-open hand-power-theorems.pdf
...
\input{ps-power-theorems-input1}
\input{ps-power-theorems-input2}
%\input{ps-power-theorems-input3}
\end{frame}
