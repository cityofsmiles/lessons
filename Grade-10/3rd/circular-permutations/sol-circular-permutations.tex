% cd /storage/emulated/0/Documents/documents/latex/1920/Grade-10/3rd/circular-permutations && count-checks sol-circular-permutations.tex && count-checks sol-circular-permutations.tex && pdflatex sol-circular-permutations.tex && divide 2x2 sol-circular-permutations.pdf 
...
\vertadjust
\begin{frame} %1
\input{sol-circular-permutations-input1} 
\end{frame}
