% cd /storage/emulated/0/Documents/documents/latex/1920/Grade-10/3rd/conditional-probability && count-checks sol-conditional-probability.tex && count-checks sol-conditional-probability.tex && pdflatex sol-conditional-probability.tex && divide 2x2 sol-conditional-probability.pdf 
...
\vertadjust
\begin{frame} %1
\input{sol-conditional-probability-input1} 
\end{frame}
